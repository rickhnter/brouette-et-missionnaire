...
export const LoginScreen = ({ onLogin, preSelectedPlayer }: LoginScreenProps) => {
  const [selectedPlayer, setSelectedPlayer] = useState<string | null>(preSelectedPlayer || null);
  ...
  const showPlayerSelection = !preSelectedPlayer;
